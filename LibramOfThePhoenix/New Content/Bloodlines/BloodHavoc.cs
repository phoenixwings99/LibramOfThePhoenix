...
using LibramOfThePhoenix.New_Components.BloodlineMutation;
using System;
...
{
    static class BloodHavoc
    {
        public static void Setup()
        {

            FeatureConfigurator.New("BloodHavocFeature", Main.LotPContext.Blueprints.GetGUID("BloodHavocFeature").m_Guid.ToString())
                .SetDisplayName("BloodHavocFeature")
                .SetDescription("BloodHavocFeature.Desc")
                .Configure();
            ...
            Main.LotPContext.Logger.Log($"Processing  sorc bloodlines for bloodline mutations");
            ...
            Main.LotPContext.Logger.Log($"Processing crossblooded sorc bloodlines for bloodline mutations");
            ...
            Main.LotPContext.Logger.Log($"Processing seeker sorc bloodlines for bloodline mutations");
            ...
            Main.LotPContext.Logger.Log($"Processing bloodrager bloodlines for bloodline mutations");
            ...
            ProcessProgression(BlueprintTool.Get<BlueprintProgression>("7d990675841a7354c957689a6707c6c2"));//Sage
            /*
        ...
        {
            Main.LotPContext.Logger.Log($"Processing progression {blueprintProgression} for bloodline mutations");
