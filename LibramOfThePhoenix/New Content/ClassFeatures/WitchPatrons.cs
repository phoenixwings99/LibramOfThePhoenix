...
namespace LibramOfThePhoenix.New_Content.ClassFeatures
{
    internal class WitchPatrons
    {
        private static readonly Logging.Logger Logger = Logging.GetLogger(nameof(WitchPatrons));
        ...
        public static void Make()
        {
            try
            {
                ...
                void ProcessPatron(PatronDefine patronDefine)
                {
                    if (patronDefine.CanComplete())
                    {
                        ...
                        var config = ProgressionConfigurator.New(patronDefine.ProgName, Main.LotPContext.Blueprints.GetGUID(patronDefine.ProgName).ToString());
                        config.SetDisplayName(LocalizationTool.GetString(patronDefine.ProgName));
                        ...
                        Main.LotPContext.Logger.LogPatch(prog);
                    ...
                    {
                        BlueprintProgression progression = TabletopTweaks.Core.Utilities.Helpers.CreateBlueprint<BlueprintProgression>(Main.LotPContext, patronDefine.ProgName, x =>
                        {
                            x.SetName(Main.LotPContext, patronDefine.Name);
                            x.AddClass(witch);
                            ...
                            for (int i = 0; i < 9; i++)
                            {
                                ...
                                BlueprintFeature feature = TabletopTweaks.Core.Utilities.Helpers.CreateBlueprint<BlueprintFeature>(Main.LotPContext, $"Witch{patronDefine.Name}PatronSpellLevel{spelllevel}", x =>
                                {
                ...
                {
                    BlueprintFeature entry = TabletopTweaks.Core.Utilities.Helpers.CreateBlueprint<BlueprintFeature>(Main.LotPContext, $"Witch{patron}PatronSpellLevel{level}", x =>
                    {
                        x.HideInCharacterSheetAndLevelUp = true;
            ...
            {
                Logger.LogException("Error in Patron Processing: ", ex);
            }
        }
        ...
        static void MakeAutumn()
        {
            ...
            spells.Add("VitrolicMist");//MUST PORT FROM FIREBIRD
        ...
        static void MakeDeath()
        {
            ...
            spells.Add("e28f4633c0a2425d8895adf20cb22f8f");//Gloombind Bolts, expanded content
            ...
            patronDefines.Add(new PatronDefine("Death", spells, Main.IsExpandedContentEnabled));


        }


        static void MakeEnchantment()
        {
            List<string> spells = new();
        ...
        static void MakePlague()
        {
            ...
            if (Settings.IsEnabled("PlaguePerniciousPoison"))
                ...
                spells.Add("0b101dd5618591e478f825f0eef155b4");//Command Undead
        ...
        {
            List<string> spells = new();
            spells.Add("f3c0b267dd17a2a45a40805e31fe3cd1");//Feather Step
        ...
        static void MakeWater()
        {
            ...
            spells.Add("c82a0d6472794d245a186eff5d6f0f41");//e body III
            spells.Add("96d2ab91f2d2329459a8dab496c5bede");// e body IV
            spells.Add("7ef49f184922063499b8f1346fb7f521");//Seamantle
            spells.Add("d8144161e352ca846a73cf90e85bf9ac");//Tsunami
