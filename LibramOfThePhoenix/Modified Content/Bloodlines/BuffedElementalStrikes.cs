...
{
    internal class BuffedElementalStrikes
    {
        public static void Do()
        {
            if (Settings.IsEnabled("BuffElementalStrikes"))
            {
                ...
                void AlterBloodline(string strikesBaseFeature, string strikesBuff, string strikes20Feature, DamageEnergyType energy)
                {
                    ...
                    at20Buff.SetDescription(LocalizationTool.GetString("ElementalStrikesBurstBuff.Desc"));
                    ...
                    Main.LotPContext.Logger.Log($"Buffed {energy} Elemental Strikes");
                }

                baseElementalRageBuff.Configure();
                Main.LotPContext.Logger.Log("Buffed All Elemental Strikes");
            }
            else
            {
