...
namespace LibramOfThePhoenix.Modified_Content.Improved_MultiarchtypeAccess
{
    public class MA_Magus
    {
        ...
        {
            if (Settings.IsDisabled("HexcrafterArcanaSelection"))
                return;
        ...
        public static void FreeUpHexcrafterLast()
        {
            ...
            FeatureSelectionConfigurator.For("ad6b9cecb5286d841a66e23cea3ef7bf").AddPrerequisiteArchetypeLevel(archetype: "79ccf7a306a5d5547bebd97299f6fc89", characterClass: "MagusClass", level: 4).SetGroup(FeatureGroup.WitchHex).SetGroup2(FeatureGroup.None).SetGroups(FeatureGroup.MagusArcana).Configure();
        ...
        {
            if (Settings.IsDisabled("ArcaneRiderFeatSelection"))
                return;
